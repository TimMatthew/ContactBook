...
struct qt_meta_stringdata_CLASSContactWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSContactWidgetENDCLASS = QtMocHelpers::stringData(
    "ContactWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSContactWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ContactWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSContactWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSContactWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSContactWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ContactWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSContactWidgetENDCLASS.stringdata0))
